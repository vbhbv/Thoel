...
# متغيرات بيئة إلزامية لتشغيل محرك QtWebEngine (Chromium المدمج في Calibre)
# داخل حاوية Docker التي تعمل بصلاحيات root وبدون بطاقة رسوميات (GPU).
# بدونها يفشل تحويل EPUB إلى PDF بخطأ "zygote_host_impl" أو مشاكل GPU/Vulkan.
